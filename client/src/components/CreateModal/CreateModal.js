...
class CreateModal extends React.Component {
	...
	render() {
		return (
			<div>
				<Button id='createBtn' variant='outlined' color='primary' onClick={this.handleClickOpen}>
					CREATE CALENDAR
				</Button>
				<Dialog
				...
				>
					...
					<DialogContent>
						<DialogContentText>Fill out the information below to start.</DialogContentText>
						<TextField
							name='first'
							margin='dense'
							id='first-name'
